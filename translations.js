...
var enMessageLang = { // Note: HTML notation for special characters not working with hints
   de: {
     ...
     userscript: 'Enstyler Script neu laden',
      ...
      injectcss: 'Es wir kein Stylish zum Laden des CSS benoetigt',
       navfixed: 'Menueleiste bleibt am oberen Rand sichtbar',
    dealvotebar: 'Bringt die Temperaturanzeigefuer Dealz zurueck ', 
  dealvotescale: 'Skalierung der Temperaturanzeige fuer Dealz',
        compact: 'Mehr Dealz anzeigen, kann zu Anzeigefehlern fuehren',
          touch: 'Symbole vergrößern damit man sie besser beruehren kann',
          width: 'Skaliere Smartphone Anzeige auf auf ausgewaehlte Breite in Pixel',
     ...
     dealaction: 'Erlaubt es z.B. direkt zu Kommentieren oder Mails zu verschicken.', 
         picker: 'Zeige Page Picker', 
       dealtime: 'Zeige die tatsaechliche Zeit statt "vor xh xm"', 
      ...
      blacklist: 'Verberge Dealz die Dich stoeren', 
      blackcold: 'Verberge Dealz die kaeter als die angebene Temperatur sind', 
        ...
        unblack: 'Anzahl ausgeblendeter Dealz, klicke um diese wieder anzuzeigen',
           lang: 'Enstyler Anzeigesprache, aktiviert auch Google Uebersetzung!',
       autosync: 'Synchronisiert zuletzt angesehenen Deal zwischen Geraeten',
       synctime: 'Letzer Dealz wird nach x Minuten inaktivitaet gespeichert',
  ...
  dealvotescale: 'Scaling of the temperature display for Dealz',
        compact: 'Show more Dealz but can lead to display errors',
          touch: 'Increase icons so they can be better touched',
     ...
     dealaction: 'More actions, e.g. to comment directly or send mail.',
         picker: 'Show Page Picker',
       dealtime: 'Show the actual time instead of "xh xm"',
      ...
      blacklist: 'Hide Dealz you don\'t like',
